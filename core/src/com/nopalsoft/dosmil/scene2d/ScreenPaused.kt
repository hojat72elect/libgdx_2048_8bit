...
class ScreenPaused(screen: Screens) : Group() {
    ...
    init {
        ...
        val labelPaused = Label(Assets.languages["pause"], Assets.labelStyleLarge)
        ...
        val labelResume = Label(Assets.languages["resume"], Assets.labelStyleSmall)
        ...
        val labelMainMenu = Label(Assets.languages["menu"], Assets.labelStyleSmall)
