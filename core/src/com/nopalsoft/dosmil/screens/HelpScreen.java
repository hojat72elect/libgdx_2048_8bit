...
public class HelpScreen extends Screens {
    ...
    public HelpScreen(final MainGame game) {
        super(game);
        labelTextHelp1 = new Label(Assets.languages.get("helpTop"), Assets.labelStyleSmall);
        ...
        imagePuzzle = new Image(Assets.puzzleSolved);
        imagePuzzle.setSize(350, 350);
        imagePuzzle.setPosition(SCREEN_WIDTH / 2 - imagePuzzle.getWidth() / 2f, 290);

        labelTextHelp2 = new Label(Assets.languages.get("helpBottom"), Assets.labelStyleSmall);
        ...
        buttonBack.setPosition(SCREEN_WIDTH / 2 - 30, 80);
